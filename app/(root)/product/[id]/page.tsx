...
import SingleProductTabComponent from "@/components/Product/SingleProductTabComponent";
import ProductQuantitySelector from "@/components/Utilities/QuantitySelector";
import ReactStarComponent from "@/components/Utilities/ReactStarComponent";
            ...
            <div className="flex flex-col justify-between p-5 ">
              ...
              <div className="flex flex-col items-center gap-5 mt-3 md:flex-row">
                ...
                <div className="flex flex-wrap w-full gap-3">
                  ...
                  <Button
                    radius="none"
                    className="w-full md:w-[60%] m-auto text-white bg-black"
                  >
                    Add To Cart
                  </Button>
                </div>
