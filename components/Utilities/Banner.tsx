...
const Banner = () => {
  return (
    <div className="h-72 w-full md:w-[70%] m-auto flex flex-col md:flex-row justify-between mt-10 items-center bg-gradient-to-br from-[#f0c899] via-transparent to-[#f3e5d2] border">
      <div className="w-full h-48 pt-5 md:w-1/2 md:h-full">
        <div className="relative flex items-center justify-center w-full h-full">
          <Image
            src="/img/headleft.png"
            alt="product"
            fill
            sizes="100vw"
            objectFit="cover"
